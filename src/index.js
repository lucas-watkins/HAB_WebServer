...
const APRSlat = data => {
  ...
  const NMEA_Sentence = data.raw;
  var NMEA_Split = NMEA_Sentence.split(',');
  //console.log(NMEA_Split);
  var tmp = NMEA_Split[3].split('.');
  var result =  tmp[0] + "." + tmp[1][0] + tmp[1][1] + NMEA_Split[4];
...
const APRSlng = data => {
  ...
  var NMEA_Split = NMEA_Sentence.split(',');
  //console.log(NMEA_Split);
  var tmp = NMEA_Split[5].split('.');
  var result =  tmp[0] + "." + tmp[1][0] + tmp[1][1] + NMEA_Split[6];
